...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    MaterialButton buttonDivide,buttonMultiply,buttonAddition,buttonSubstraction,buttonEquals;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        assignId(buttonSubstraction,R.id.button_substraction);
    ...
    // Define the getResult method outside of onClick method
